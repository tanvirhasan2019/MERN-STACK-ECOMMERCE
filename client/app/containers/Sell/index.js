  ...
  render() {
    ...
    return (
      <div className='sell'>
        ...
        <h2>Become A Tanshen Technology Seller!</h2>
        <hr />
        <Row>
            ...
            <Row>
              <Col xs='12' className='order-2 order-md-1 text-md-center mb-3'>
                <div className='agreement-banner-text'>
                  <h3>Would you like to sell your products on Tanshen Technology!</h3>
                  <h4>Grow your business with Tanshen Technology</h4>
                  <b>Apply Today</b>
                </div>
              </Col>
