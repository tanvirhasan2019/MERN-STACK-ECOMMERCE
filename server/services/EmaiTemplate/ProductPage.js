module.exports = function (data, contact , link) { 
                  ...
                  <tr>
                    <td align="left" valign="top" style="padding: 0 10px;">
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                        <tbody>
                          <tr>
                            <td class="pc-sm-p-35-30-40 pc-xs-p-20-20-25" valign="top" bgcolor="#ffffff" style="padding: 35px 40px 40px; background-color: #ffffff; border-radius: 8px;">
                              <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                <tbody>
                                  <tr>
                                            ...
                                            <td valign="top" align="center" style="border-radius: 14px; border: 1px solid #CDCED2; padding: 6px 9px;">
                                              <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                <tbody>
                                                  <tr>
                                                    <td valign="middle">
                                                      <a class="pc-fb-font" href=${`${link}/shop`} style="text-decoration: none; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; display: block; font-size: 14px; font-weight: 500; color: #4B4B4B; line-height: 14px; white-space: nowrap;"><span>See all</span></a>
                                                    </td>
                                ...
                                <tbody>
                                  <tr>
                                    <td valign="top" align="center">
                                      <img src=${`${item.imageUrl}`} width="384" height="400" alt="" style="border: 0; line-height: 100%; outline: 0; -ms-interpolation-mode: bicubic; display: block; color: #151515; max-width: 100%; height: auto; Margin: 0 auto;">
                                    </td>
                                  </tr>
                                  <tr>
                                ...
                                <tbody>
                                  <tr>
                                    <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 500; color: #FF5733;" valign="top" align="center">
                                      Hot Sale
                                    </td>
                                  </tr>
                                  <tr>
                                ...
                                <tbody>
                                  <tr>
                                    <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 24px; font-weight: 500; line-height: 28px; color: #9B9B9B;" valign="top" align="center">
                                     ৳ ${item.price}
                                    </td>
                                  </tr>
                                  <tr>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td style="border-radius: 8px; padding: 13px 17px; background-color: #1595E7;" bgcolor="#1595E7" valign="top" align="center">
                                              <a href=${`${link}/product/${item.slug}`} style="line-height: 24px; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff;">Shop now</a>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
